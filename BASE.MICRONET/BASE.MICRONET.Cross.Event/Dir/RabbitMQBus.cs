...
namespace BASE.MICRONET.Cross.Event.Dir
{
    public class RabbitMQBus : IEventBus
    {
        ...
        public void Publish<T>(T @event) where T : BASE.MICRONET.Cross.Event.Dir.Events.Event
        {
        ...
        private void StartBasicConsume<T>() where T : BASE.MICRONET.Cross.Event.Dir.Events.Event
        {
            var factory = new ConnectionFactory()
            {
                HostName = _options.Hostname,
